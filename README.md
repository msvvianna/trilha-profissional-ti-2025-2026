# trilha-profissional-ti-2025-2026

# 🚀 Trilha de Estudos 2025/2026 – Marcos Viana

> **Objetivo**: Esta trilha tem como propósito guiar minha transição estratégica de Analista de Data Center Sênior para Arquiteto de Soluções com foco em **DevOps, Cloud Computing e IA**.  
...
| **DevOps**                  | Infraestrutura como Código, Observabilidade        | Linux, Github Actions, Docker, Terraform, Kubernetes, Ansible, Prometheus, Zabbix, Grafana |
| **Python**                  | Desenvolvimento de APIs e microsserviços           | FastAPI, Streamilit, Langchain                                                             |
...
- [ ] ⏳ Projetos com MLOps (FastAPI + CI/CD)
- [ ] ⏳ Projeto Python + Docker + Observabilidade
...
| `springboot-monitoring-api`       | API Python com FastAPI + Observabilidade (Elastic, Filebeat)         | 📝 Planejado     |
